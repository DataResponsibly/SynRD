...
# NOTE: Temporarily adding here for tests
class SmartnoiseAIMSynthesizer(Synthesizer):
    ...
    def __init__(self, epsilon=1., delta=1e-9, max_model_size=80, degree=2, num_marginals=None, max_cells: int = 10000,
                 rounds=None, verbose=False, rounds_factor=0.2):
        self.rounds = rounds
    ...
    def AIM(self, data, workload):
        ...
        rounds = int(rounds * self.rounds_factor)
